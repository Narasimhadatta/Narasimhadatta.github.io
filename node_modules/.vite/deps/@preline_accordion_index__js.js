    ...
    !function(t, e) {
      ...
      var t = { 460: function(t2, e2, n2) {
        ...
        var s = n2(969), l = function(t3) {
          ...
          return i(e3, t3), e3.prototype.init = function() {
            ...
            this.el.classList.add("active"), this.content.style.display = "block", this.content.style.height = "0", setTimeout(function() {
              ...
              t4.content.style.display = "block", t4.content.style.height = "", t4.fireEvent("open", t4.el), (0, s.dispatch)("open.hs.accordion", t4.el, t4.el);
            });
            ...
            this.el.classList.remove("active"), this.content.style.height = "".concat(this.content.scrollHeight, "px"), setTimeout(function() {
              ...
              t4.content.style.display = "", t4.content.style.height = "0", t4.fireEvent("close", t4.el), (0, s.dispatch)("close.hs.accordion", t4.el, t4.el);
            });
        ...
        e2.isEnoughSpace = function(t3, e3, n3, o2, i) {
          ...
          var r = e3.getBoundingClientRect(), c = i ? i.getBoundingClientRect() : null, s = window.innerHeight, l = c ? r.top - c.top : r.top, a = (i ? c.bottom : s) - r.bottom, u = t3.clientHeight + o2;
